...
export class EditAgentComponent implements OnInit {
  ...
  submitForm(){
    ...
    this.webService.createPost({ url: BaseUrl.apiUrl("updateAgent")+`?userId=${this.agentDetails._id}`, body: this.createAgent.value, contentType: true, loading: true }).then(res => {
      if (res["status"]) {
